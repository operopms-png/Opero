              ...
              <div style={{marginBottom:16}}>
                ...
                {customModules.includes('sc')&&(
                  <div style={{marginTop:10,padding:12,background:'#F9FAFB',border:'1px solid #E4E7EC',borderRadius:8}}>
                    ...
                    <div style={{fontSize:11,color:'#98A2B3',marginBottom:8}}>Every tab is unlocked by default. Untick any tab to lock it for this person — only admins can unlock it again.</div>

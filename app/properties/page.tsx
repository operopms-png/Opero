      ...
      <div style={{ maxWidth: 1200, margin: '0 auto', padding: '32px' }}>
        ...
        <div style={{ marginBottom: 24 }}>
          <input
            ...
            style={{ padding: '10px 16px', borderRadius: 10, border: '1px solid #E5E7EB', fontSize: 14, width: 280, fontFamily: 'inherit', background: '#fff' }}
          />
        </div>
        ...
        {loading ? (
          ...
          <div style={{ textAlign: 'center', padding: 80, color: '#9CA3AF' }}>
            ...
            {!search && <div style={{ fontSize: 14, marginTop: 4 }}>Add your first property to get started</div>}
          </div>
        ) : (
              ...
              return (
                <div key={p.id} style={{ background: '#fff', borderRadius: 14, border: '1px solid #E5E7EB', overflow: 'hidden' }}>
                  ...
                  <div style={{ padding: '16px 18px' }}>
                    ...
                    {p.address && (
                      <div style={{ fontSize: 13, color: '#9CA3AF', marginBottom: 12 }}>{p.address}</div>
                    )}
                    ...
                    <div style={{ display: 'flex', gap: 8, marginTop: 14 }}>
                      <button
                        onClick={() => openEdit(p)}
                        style={{ flex: 1, padding: '8px', borderRadius: 8, border: '1px solid #E5E7EB', background: '#fff', fontSize: 13, fontWeight: 500, cursor: 'pointer', fontFamily: 'inherit' }}
                      >
                        Edit
                      </button>
                      <button
                        onClick={() => deleteProperty(p.id)}
                        style={{ padding: '8px 12px', borderRadius: 8, border: '1px solid #FEE2E2', background: '#FFF5F5', color: '#EF4444', fontSize: 13, fontWeight: 500, cursor: 'pointer', fontFamily: 'inherit' }}
                      >
                        Delete
                      </button>
                    </div>
